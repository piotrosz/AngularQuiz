namespace AngularQuiz.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AngularQuizContext>
    {
        ...
        protected override void Seed(AngularQuizContext context)
        {
        ...
        private static void AddSampleUsers(AngularQuizContext context)
        {
        ...
        private static void AddOpenQuestions(AngularQuizContext context, Quiz quiz)
        {
        ...
        private static void AddTestQuestions(AngularQuizContext context, Quiz quiz)
        {
        ...
        private static void AddCategoryQuestions(AngularQuizContext context, Quiz quiz)
        {
        ...
        private static void AddSortQuestions(AngularQuizContext context, Quiz quiz)
        {
